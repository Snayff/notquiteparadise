...
from Code.Entities.death_functions import kill_monster, kill_player
from Code.Entities.entity import get_blocking_entities_at_location
from Code.Draw.fov_functions import initialize_fov, recompute_fov
...
def main():
	...
	main_menu_background_image = libtcod.image_load('Assets/Menus/menu_background.png')
