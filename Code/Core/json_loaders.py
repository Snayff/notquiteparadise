...
def save_game(player, entities, game_map, message_log, game_state):
	...
	with open('Data/save_game.json', 'w') as save_file:
		json.dump(data, save_file, indent=4)


def load_game():
	with open('Data/save_game.json') as save_file:
...
def get_text_from_json(stringID):
	languageFileName = "ENG"

	with open('Data/' + languageFileName + '.json') as save_file:
		data = json.load(save_file)
