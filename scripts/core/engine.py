...
from scripts.core.global_data import world_manager, game_manager, entity_manager
from scripts.core.input_handlers import get_input, handle_input
...
def main():
	...
	pygame.quit()  # clean uyp pygame resources
...
def draw_entities():
	main_surface.blit(SPRITE_PLAYER, (entity_manager.player.x * TILE_SIZE, entity_manager.player.y * TILE_SIZE))
