...
from scripts.engine.core.definitions import (AfflictionData, AspectData, BasePrimaryStatData,
    BaseSecondaryStatData, GodData, SkillData, TraitData)
...
VIDEO_CONFIG: Dict[str, Union[Dict[int], int]] = {}
GAME_CONFIG: Dict[str, Union[Dict[int], int]] = {}
