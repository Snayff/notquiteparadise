...
class ActorInfo(Window):
    ...
    def show(self):
        ...
        if entity:
            ...
            # get identity
            identity = scripts.engine.core.entity.get_entitys_component(entity, Identity)
            info.append(("text", identity.name))

            # get resources
            resources = scripts.engine.core.entity.get_entitys_component(entity, Resources)
            if resources:
            ...
            try:
                traits = scripts.engine.core.entity.get_entitys_component(entity, Traits)
                if traits:
                    names = ""
